...
- Candidate queries and final mutation endpoints must use this same authoritative capacity resolver. Students receive only public selectability and availability-resumption dates; internal availability reasons must not appear in resolutions or conflict messages.
