    ...
    <div id="mark-entry-detail-page" className="space-y-6 text-left">
      ...
      <div>
        <button
          ...
          type="button"
          onClick={onBack}
          className="group inline-flex items-center gap-2 text-sky-600 hover:text-sky-800 font-extrabold text-xs uppercase tracking-wider transition-all cursor-pointer"
        >
